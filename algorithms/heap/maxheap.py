...
Complete (or almost) tree where the parent node is always bigger than its
childs.
...
Applications:
Heap sort
Keep track of maximum element of a list
"""
class MaxHeap():
    ...
    def remove(self):
        """
        I remove an elemente of the heap.
...
def heapsort(list):
    ...
    # remove biggest element from heap and add to result
    result = []
    while heap.size() > 0:
